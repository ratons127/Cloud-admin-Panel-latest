<template>
    ...
    <v-card>
        ...
        <v-row no-gutters style='margin-top:25px;'>
          ...
          <v-col cols="12">
            <div style='display:flex;'>
              ...
              <div style='flex:50%;margin-left: 25px;'>
                <v-text-field v-model="termOptionsThemeForeground" v-maska="mask" hide-details label="Foreground color" variant="outlined" class="ma-0 pa-0 colorField">
                  <template v-slot:append>
                    <v-menu v-model="themeForegroundMenu" location="top" offset="16" :close-on-content-click="false" >
                      <template v-slot:activator="{ props }">
                        <div v-bind:style="getColorFieldStyle(0)" v-bind="props" />
                      </template>
                      <v-card>
          ...
          <v-col cols="12" style='margin-bottom:30px;'>
            <div style='display:flex;'>
              <div style='flex:50%;'>
                <v-text-field v-model="termOptionsThemeBackground" v-maska="mask" hide-details label="Background color" variant="outlined" class="ma-0 pa-0 colorField">
                  <template v-slot:append>
                    <v-menu v-model="themeBackgroundMenu" location="top" offset="16" :close-on-content-click="false" >
                      <template v-slot:activator="{ props }">
                        <div v-bind:style="getColorFieldStyle(1)" v-bind="props" />
                      </template>
                      <v-card>
                        <v-card-text class="pa-0">
              ...
              <div style='flex:50%;margin-left: 25px;'>
                <v-text-field v-model="termOptionsThemeCursor" v-maska="mask" hide-details label="Cursor color" variant="outlined" class="ma-0 pa-0 colorField">
                  <template v-slot:append>
                    <v-menu v-model="themeCursorMenu" location="top" offset="16" :close-on-content-click="false" >
                      <template v-slot:activator="{ props }">
                        <div v-bind:style="getColorFieldStyle(2)" v-bind="props" />
                      </template>
                      <v-card>
                        <v-card-text class="pa-0">
          ...
          <v-col cols="12">
            <div style='display:flex;'>
              <div style='flex:50%;'>
                <v-text-field v-model="termOptionsThemeCursorAccent" v-maska="mask" hide-details label="Cursor accent color" variant="outlined" class="ma-0 pa-0 colorField">
                  <template v-slot:append>
                    <v-menu v-model="themeCursorAccentMenu" location="top" offset="16" :close-on-content-click="false" >
                      <template v-slot:activator="{ props }">
                        <div v-bind:style="getColorFieldStyle(3)" v-bind="props" />
                      </template>
                      <v-card>
                        <v-card-text class="pa-0">
      ...
      <v-card-actions>
        <v-spacer></v-spacer>
        <v-btn color="green-darken-1"  variant="text" @click="closeSettings">Cancel</v-btn>
        <v-btn color="green-darken-1"  variant="text" v-on:click="saveSettings">Save</v-btn>
      </v-card-actions>
    </v-card>
    </v-dialog>
</template>
